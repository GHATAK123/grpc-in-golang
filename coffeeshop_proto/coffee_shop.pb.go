...
const file_coffee_shop_proto_rawDesc = "" +
	...
	"\x0eGetOrderStatus\x12\x13.coffeeshop.Receipt\x1a\x17.coffeeshop.OrderStatus\"\x00B!Z\x1fgrpc-in-golang/coffeeshop_protob\x06proto3"
...
var file_coffee_shop_proto_depIdxs = []int32{
	...
	0, // 2: coffeeshop.CoeffeShop.GetMenu:input_type -> coffeeshop.MenuRequest
	2, // 3: coffeeshop.CoeffeShop.PlaceOrder:input_type -> coffeeshop.Order
	1, // 4: coffeeshop.CoeffeShop.GetOrderStatus:input_type -> coffeeshop.Receipt
	4, // 5: coffeeshop.CoeffeShop.GetMenu:output_type -> coffeeshop.Menu
	1, // 6: coffeeshop.CoeffeShop.PlaceOrder:output_type -> coffeeshop.Receipt
	3, // 7: coffeeshop.CoeffeShop.GetOrderStatus:output_type -> coffeeshop.OrderStatus
